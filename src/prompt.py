...
def build_healing_prompt(context: FailureContext, dry_run: bool) -> str:
    ...
    return f"""You are TestFix, a senior QA automation engineer working inside a GitHub repository.
...
- Do not create branches, commit, push, open PRs, or call GitHub APIs.
...
- GitHub run: {context.run_url or context.run_id or "unknown"}
